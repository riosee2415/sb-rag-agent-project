  ...
  return (
    ...
    >
      <div style={{ maxWidth: 'var(--chat-max-w)' }}>
        ...
        <div className="mb-8">
          <span style={{ fontFamily: v.fontMono, fontSize: '11px', color: v.textDim, letterSpacing: '0.05em' }}>
            v0.11
          </span>
        </div>
        ...
        {/* Description */}
        <div className="mb-1">
          <span style={{ fontFamily: v.fontMono, fontSize: '13px', color: v.textMuted }}>
            knowledge agent for youtube channels
          </span>
        </div>
        <div className="mb-10">
          <span style={{ fontFamily: v.fontMono, fontSize: '13px', color: v.textDim }}>
            currently indexed:{' '}
